...
const SmartEngagementOrchestrator_1 = require("../lib/engagement/SmartEngagementOrchestrator");
...
async function notifyAdminOnError(error, context) {
...
async function main() {
    ...
    try {
        ...
        const results = await SmartEngagementOrchestrator_1.SmartEngagementOrchestrator.runDailyCampaign();
        ...
        console.error('========================================\n');
        await notifyAdminOnError(error instanceof Error ? error : new Error(String(error)), 'Smart Engagement Campaign');
        process.exit(1);
    }
    finally {
