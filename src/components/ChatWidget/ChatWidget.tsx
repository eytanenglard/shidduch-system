...
// --- שאלות מוצעות ממוקדות יתרון ---
const promptQuestions = [
  'במה השיטה שלכם שונה מאפליקציה?',
  'איך אתם שומרים על הפרטיות שלי?',
  'מהו התהליך מרגע ההרשמה?',
  'מה העלות ומה כלול בשירות?',
];

const EMAIL_REGEX = /\S+@\S+\.\S+/;

// --- טקסטים משוכתבים עם קול המותג ---
const TEXTS = {
  welcome:
    'שלום, אנחנו NeshamaTech. אנו יודעים שהדרך למציאת זוגיות משמעותית יכולה להיות מאתגרת. לכן, יצרנו תהליך המשלב טכנולוגיה מתקדמת עם ליווי אישי וחם, כדי להעניק לכם חוויה דיסקרטית, מכבדת ויעילה. במה נוכל לעזור?',
  limitReached:
    'הגעתם למגבלת 10 השאלות בשיחה זו. כדי שנוכל להמשיך ולהעניק לכם מענה אישי ומעמיק, נשמח להמשיך את השיחה במייל. השאירו פנייה והצוות שלנו יחזור אליכם.',
  switchToEmailPrompt:
    'בשמחה. כדי שנוכל לחזור אליכם עם תשובה אישית, אנא רשמו את כתובת המייל שלכם. הפרטים יישמרו בדיסקרטיות מלאה.',
  composeEmailPrompt:
    'מעולה. כעת, כתבו את פנייתכם ואחד מאנשי הצוות שלנו יחזור אליכם באופן אישי.',
  ...
  placeholderDefault: 'שאלו אותנו על התהליך, הפרטיות...',
