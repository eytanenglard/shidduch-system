...
const defaultFAQItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        <p>
          המידע שלך נשמר בסודיות מוחלטת. רק צוות המאצ'מייקינג המקצועי שלנו יכול
  ...
  },
  {
    ...
    answer: (
      <p>
        אם חשבונך לא יהיה פעיל למשך 3 חודשים, נשלח לך התראה בדוא"ל. לאחר 6
...
export default function FAQ({
  ...
  // טיפול בשינוי מצב פתיחת אקורדיון
