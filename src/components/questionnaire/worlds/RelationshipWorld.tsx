  ...
  if (!isIntroComplete) {
    return (
      <WorldIntro
        ...
        title="עולם הזוגיות: לבנות קשר משמעותי"
        description="ברוכים הבאים לעולם הזוגיות! כאן נבחן יחד את הציפיות שלך מקשר, את סגנון התקשורת המועדף עליך, ואיך את/ה רואה את חיי היומיום המשותפים והחזון המשפחתי. הבנה מעמיקה של צרכיך ורצונותיך תסייע לנו למצוא התאמה שיש לה פוטנציאל לקשר חזק ויציב."
