    ...
    options: [
      {
        ...
        value: 'קהילה תורנית חזקה עם דמות רבנית משמעותית',
      },
      {
        icon: <Scale />,
        text: 'קהילה מעורבת עם מגוון רמות דתיות',
        value: 'קהילה מעורבת עם מגוון רמות דתיות',
      },
      {
        icon: <Users />,
        text: 'קהילה צעירה ודינמית עם הרבה משפחות צעירות',
        value: 'קהילה צעירה ודינמית עם הרבה משפחות צעירות',
      },
      {
        icon: <Sparkles />,
        text: 'קהילה פתוחה וליברלית מבחינה דתית וחברתית',
        value: 'קהילה פתוחה וליברלית מבחינה דתית וחברתית',
      },
      {
        icon: <Heart />,
        text: 'קהילה חמה, תומכת ומגובשת חברתית',
        value: 'קהילה חמה, תומכת ומגובשת חברתית',
      },
      {
        icon: <ShieldCheck />,
        text: 'קהילה שקטה ומבוססת עם דגש על פרטיות',
        value: 'קהילה שקטה ומבוססת עם דגש על פרטיות',
      },
    ],
    minSelections: 1,
    maxSelections: 3,
    ...
    options: [
      {
        ...
        value: 'מרכז הארץ - קרבה לתעסוקה, תרבות ומשפחה',
      },
      {
        icon: <TrendingUp />,
        text: 'פריפריה - איכות חיים, קהילתיות ועלויות מחיה נוחות יותר',
        value: 'פריפריה - איכות חיים, קהילתיות ועלויות מחיה נוחות יותר',
      },
      {
        icon: <DollarSign />,
        text: 'מגורים ביישוב בעל עלות מחיה סבירה הם עדיפות עליונה',
        value: 'מגורים ביישוב בעל עלות מחיה סבירה הם עדיפות עליונה',
      },
      {
        icon: <Briefcase />,
        text: 'קרבה למרכזי תעסוקה רלוונטיים עבורי ועבור בן/בת הזוג',
        value: 'קרבה למרכזי תעסוקה רלוונטיים עבורי ועבור בן/בת הזוג',
      },
      {
        icon: <Home />,
        text: 'קרבה למשפחת המוצא שלי או של בן/בת הזוג',
        value: 'קרבה למשפחת המוצא שלי או של בן/בת הזוג',
      },
    ],
    minSelections: 1,
    maxSelections: 2,
