...
export const relationshipQuestions: Question[] = [
  ...
  },
  {
    ...
    maxSelections: 2,
    options: [
      { value: 'מילים מחזקות ומעודדות', text: 'מילים מחזקות ומעודדות' },
      { value: 'זמן איכות אמיתי ושיחה', text: 'זמן איכות אמיתי ושיחה' },
      { value: 'מגע פיזי וחם', text: 'מגע פיזי וחם' },
      {
        value: 'עזרה מעשית ודאגה (שירותים)',
        text: 'עזרה מעשית ודאגה (שירותים)',
      },
      { value: 'קבלת מתנות ופינוקים', text: 'קבלת מתנות ופינוקים' },
    ],
    metadata: {
      estimatedTime: 1,
      helpText:
