...
},
{
  ...
  {
    worldId: 'RELATIONSHIP',
    id: 'relationship_approach_second_time',
    category: 'relationship',
    subcategory: 'core_expectations',
    type: 'openText',
    depth: 'BASIC',
  ...
  {
    worldId: 'RELATIONSHIP',
    id: 'relationship_pacing_second_marriage',
    category: 'relationship',
    subcategory: 'core_expectations',
    type: 'iconChoice',
    depth: 'ADVANCED',
    isRequired: false,
    options: [
      { value: 'slow_careful', icon: <Moon /> },
      { value: 'moderate_pace', icon: <Clock /> },
      { value: 'follow_the_heart', icon: <Heart /> },
      { value: 'depends_on_connection', icon: <Sparkles /> },
    ],
    conditions: { maritalStatus: ['DIVORCED', 'WIDOWED'] },
    metadata: { estimatedTime: 1 },
  },
  {
    worldId: 'RELATIONSHIP',
    id: 'relationship_blended_family_vision',
    category: 'relationship',
    subcategory: 'family_future_vision',
    type: 'openText',
    depth: 'BASIC',
    ...
    minLength: 50,
    maxLength: 400,
    conditions: { maritalStatus: ['DIVORCED', 'WIDOWED'], hasChildren: true },
    metadata: { estimatedTime: 3 },
  },
  ...
  {
    worldId: 'RELATIONSHIP',
    id: 'relationship_companionship_senior',
    category: 'relationship',
    subcategory: 'core_expectations',
    type: 'multiSelect',
    depth: 'BASIC',
    ...
    maxSelections: 3,
    options: [
      { value: 'daily_companionship', icon: <Coffee /> },
      { value: 'travel_adventures', icon: <Map /> },
      { value: 'shared_grandchildren', icon: <Baby /> },
      { value: 'mutual_health_support', icon: <HandHeart /> },
      { value: 'intellectual_partnership', icon: <Brain /> },
      { value: 'spiritual_growth_together', icon: <BookOpen /> },
    ],
  ...
  {
    worldId: 'RELATIONSHIP',
    id: 'relationship_children_vision_senior',
    category: 'relationship',
    subcategory: 'family_future_vision',
    type: 'iconChoice',
    depth: 'BASIC',
    isRequired: false,
    options: [
      { value: 'not_relevant_at_this_stage', icon: <Scale /> },
      { value: 'open_if_possible', icon: <Heart /> },
      { value: 'grandchildren_are_enough', icon: <Baby /> },
      { value: 'would_still_consider', icon: <Sparkles /> },
    ],
    conditions: { ageRange: [55, 120] },
    metadata: { estimatedTime: 1 },
  },
