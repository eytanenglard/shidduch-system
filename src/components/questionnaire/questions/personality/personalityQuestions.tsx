...
export const personalityQuestions: Question[] = [
  ...
  // עוברים לשאלות קונקרטיות וקלות יותר על הרגלים יומיומיים.
  {
    ...
    question:
      "עבר עליך שבוע עמוס ואינטנסיבי. את/ה מרגיש/ה שה'סוללה' שלך קרובה להתרוקן. הגיע יום חמישי בערב, ויש לך ערב פנוי לחלוטין. איזו מהאפשרויות הבאות הכי קורצת לך ומרגישה כמו 'שקע הטעינה' המושלם עבורך?",
    type: 'scenario',
    depth: 'BASIC',
    isRequired: true,
    options: [
