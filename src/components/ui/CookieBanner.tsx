    ...
    <div className="fixed bottom-0 left-0 right-0 bg-slate-800/95 backdrop-blur-sm text-white p-4 z-[100] shadow-lg">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-slate-200 text-center sm:text-right">
          {/* שינוי: המרכאות הוחלפו בייצוג HTML מתאים */}
          אנו משתמשים ב&ldquo;עוגיות&rdquo; (Cookies), כולל אלו של Google
          Analytics, כדי לשפר את חווית הגלישה שלך ולנתח את תנועת הגולשים באתר.
          המידע נאסף באופן אנונימי. למידע נוסף, אנא עיין/י ב
          <Link
            href="/legal/privacy-policy"
            className="underline hover:text-cyan-300 mx-1"
          >
            מדיניות הפרטיות
          </Link>
          שלנו.
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <Button
            ...
            variant="outline"
            className="text-white border-slate-500 hover:bg-slate-700 hover:text-white"
          >
            מסרב/ת
          </Button>
          <Button
