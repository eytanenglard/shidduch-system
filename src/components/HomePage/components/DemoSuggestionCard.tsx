    ...
    >
      <Card className="w-full max-w-sm mx-auto shadow-2xl rounded-2xl overflow-hidden bg-white border-2 border-cyan-100/50">
        <div className="relative h-48 bg-gray-200">
          {/* 2. שימוש בפונקציה החדשה ועדכון הנתיב ל-public ID */}
          <Image
            src={getRelativeCloudinaryPath('team/dina4.jpg')}
            alt="דוגמת פרופיל"
            layout="fill"
        ...
        <CardContent className="p-4">
          ...
          <div className="mt-2 space-y-2 text-sm text-gray-600">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>דתיה לאומית</span>
            </div>
          </div>
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-xs text-gray-500 leading-relaxed italic">
              אשת שיחה מרתקת עם לב רחב, מחפשת קשר רציני המבוסס על כבוד הדדי
              וצמיחה רוחנית.
            </p>
          </div>
        </CardContent>
