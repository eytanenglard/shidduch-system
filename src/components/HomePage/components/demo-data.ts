...
export const generateDemoData = async (locale: Locale) => {
  ...
  const noaProfile: PartyInfo = {
    ...
    profile: {
     wantsToBeFirstParty: true,
      ...
      headCovering: null, kippahType: null, bodyType: null, appearanceTone: null, groomingStyle: null, preferredBodyTypes: [], preferredAppearanceTones: [], preferredGroomingStyles: [],
      ...
      smokingStatus: null, preferredSmokingStatus: null,
      ...
      preferredKippahTypes: [], preferredCharacterTraits: [], preferredHobbies: [], preferredAliyaStatus: 'no_preference', preferredReligiousJourneys: [], preferredEthnicBackgrounds: [],
      isProfileVisible: true, preferredMatchmakerGender: null, matchingNotes: '', internalMatchmakerNotes: '', verifiedBy: null, availabilityStatus: AvailabilityStatus.AVAILABLE,
  ...
  const danielProfile: PartyInfo = {
    ...
    profile: {
      ...
      headCovering: null, bodyType: null, appearanceTone: null, groomingStyle: null, preferredBodyTypes: [], preferredAppearanceTones: [], preferredGroomingStyles: [],
      manualEntryText: isHebrew
