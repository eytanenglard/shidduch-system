...
export const generateDemoData = async (locale: Locale) => {
  ...
  const noaProfile: PartyInfo = {
    ...
    profile: {
      ...
      aliyaCountry: null, aliyaYear: null,  inspiringCoupleStory: 'Inspiring couple story', influentialRabbi: 'Influential rabbi',
  ...
  const danielProfile: PartyInfo = {
    ...
    profile: {
      ...
      aliyaCountry: 'ארה"ב', aliyaYear: 2004, inspiringCoupleStory: 'Inspiring couple story', influentialRabbi: 'Influential rabbi',
