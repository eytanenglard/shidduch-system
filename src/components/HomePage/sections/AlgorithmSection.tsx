        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="mb-8">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-cyan-600 to-cyan-700 rounded-full mb-6"></div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg p-5 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100">
                <div className="flex items-start">
                  <div className="p-3 rounded-full bg-gradient-to-br from-cyan-50 to-cyan-100 text-cyan-600 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      על בסיס 50+ ממדי התאמה שונים - הרבה מעבר למה שעין אנושית
                      יכולה לעבד
                    </p>
                  </div>
                </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-cyan-700/5 rounded-2xl transform rotate-3"></div>
            <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-cyan-100">
              ...
              <pre>
                <code className="font-mono text-sm text-left" dir="ltr">
                  <div>
                    <span className="text-purple-600">const</span>{" "}
                    <span className="text-cyan-600">findBestMatch</span>{" "}
                    <span className="text-gray-500">=</span>{" "}
                    <span className="text-purple-600">(</span>
                    <span className="text-orange-600">targetUser</span>,{" "}
                    <span className="text-orange-600">candidates</span>
                    <span className="text-purple-600">)</span>{" "}
                    <span className="text-purple-600">{`=>`}</span>{" "}
                    <span className="text-purple-600">{`{`}</span>
                  </div>
                  ...
                  <div className="pl-4">
                    <span className="text-purple-600">const</span>{" "}
                    <span className="text-orange-600">eligible</span>{" "}
                    <span className="text-gray-500">=</span> candidates.
                    <span className="text-cyan-600">filter</span>(
                    <span className="text-orange-600">c</span>{" "}
                    <span className="text-purple-600">{`=>`}</span>{" "}
                    c.gender !== targetUser.gender
                    );
                  </div>
                  <div className="pl-4 text-gray-500">
                  ...
                  <div className="pl-4">
                    <span className="text-purple-600">const</span>{" "}
                    <span className="text-orange-600">scores</span>{" "}
                    <span className="text-gray-500">=</span> eligible.
                  ...
                  <div className="pl-8">
                    score: <span className="text-cyan-600">calculateWeightedScore</span>
                    (targetUser, c),
                  </div>
                  ...
                  <div className="pl-4">
                    scores.<span className="text-cyan-600">sort</span>((
                    <span className="text-orange-600">a</span>,{" "}
                    <span className="text-orange-600">b</span>) <span className="text-purple-600">{`=>`}</span> b.score - a.score);
                  </div>
                  <div className="pl-4 text-gray-500">
                    {'// 4. Return the best match'}
                  </div>
                  <div className="pl-4">
                    <span className="text-purple-600">return</span> scores[<span className="text-cyan-600">0</span>];
                  </div>
                  <div>
                    <span className="text-purple-600">{'}'}</span>;
                  </div>
