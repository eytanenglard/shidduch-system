            ...
            <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-cyan-100">
              ...
              >
                <div className="mb-1">
                  ...
                  <span className="text-cyan-600">computeCompatibility</span>{" "}
                ...
                <div className="mb-1 pl-4">
                  compatibilityScore <span className="text-gray-500">+=</span>{" "}
                  <span className="text-cyan-600">valueCompatibility</span>
                ...
                <div className="mb-1 pl-4">
                  compatibilityScore <span className="text-gray-500">+=</span>{" "}
                  <span className="text-cyan-600">lifestyleCompatibility</span>
                  <span className="text-purple-600">(</span>profile1, profile2
                  <span className="text-purple-600">)</span>{" "}
                  <span className="text-gray-500">*</span>{" "}
                ...
                <div className="mb-1 pl-4">
                  compatibilityScore <span className="text-gray-500">+=</span>{" "}
                  <span className="text-cyan-600">familyCompatibility</span>
                  <span className="text-purple-600">(</span>profile1, profile2
                  <span className="text-purple-600">)</span>;
                </div>
                <div className="mb-1 pl-4 text-gray-500">
                ...
                <div className="mb-1 pl-4">
                  compatibilityScore <span className="text-gray-500">+=</span>{" "}
                  <span className="text-cyan-600">goalsCompatibility</span>
                  <span className="text-purple-600">(</span>profile1, profile2
                  <span className="text-purple-600">)</span>{" "}
                  <span className="text-gray-500">*</span>{" "}
                  <span className="text-cyan-600">1.5</span>;
                </div>
                <div className="mb-1 pl-4 text-gray-500">
                ...
                <div className="mb-1 pl-4">
                  ...
                  compatibilityScore <span className="text-gray-500">/</span>{" "}
                  <span className="text-cyan-600">maxPossibleScore</span>;
                </div>
                <div>
                  <span className="text-purple-600">{"}"}</span>;
                </div>
