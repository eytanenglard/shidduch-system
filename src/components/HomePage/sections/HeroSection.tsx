...
const HeroSection: React.FC<HeroSectionProps> = ({ session, isVisible }) => {
  ...
  return (
    ...
    >
      ...
      {/* Animated floating orbs with parallax effect */}
      <div
        className="absolute top-20 right-[15%] w-32 h-32 rounded-full bg-gradient-to-br from-cyan-200/20 to-cyan-300/10 animate-float-slow backdrop-blur-sm"
        style={{
      ...
      ></div>
      <div
        className="absolute -bottom-10 left-[10%] w-40 h-40 rounded-full bg-gradient-to-br from-pink-200/20 to-pink-300/10 animate-float-slow backdrop-blur-sm"
        style={{
      ...
      <div className="relative w-full mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <Card className="group relative overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 rounded-xl max-w-md mx-auto lg:mr-0 lg:ml-auto">
                  ...
                  <CardContent className="relative p-6 flex items-center">
                    <div className="relative p-4 mr-5 rounded-full bg-gradient-to-r from-cyan-500 to-pink-500 shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-110 overflow-hidden">
                      ...
                      <ClipboardList className="relative z-10 w-6 h-6 text-white" />
                    </div>
                    <div>
                    ...
                    <ArrowLeft className="h-6 w-6 mr-auto text-pink-500 opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-500" />
                  </CardContent>
                </Card>
              </Link>
            </div>
          ...
          <div
            ...
            className={`lg:col-span-6 relative h-[450px] sm:h-[550px] md:h-[650px] transition-all duration-1000 transform ${
              isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full max-w-2xl aspect-square">
                ...
                <div
                  ...
                  style={{
                    transform: `translate(calc(-50% + ${
                      puzzleAnim.progress * 90
                    }px), -50%)`,
                  }}
                >
                  <div className="relative">
                    <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-3xl bg-gradient-to-br from-cyan-400 to-cyan-600 shadow-xl flex items-center justify-center transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                      {/* Background pattern */}
                      ...
                      <div className="absolute right-0 top-1/2 transform translate-x-1/4 -translate-y-1/2 w-16 h-40 overflow-visible z-10">
                        <div className="absolute inset-0 bg-cyan-500 rounded-l-2xl shadow-lg"></div>
                        <div className="absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white rounded-full border-8 border-cyan-500/80 shadow-lg z-20"></div>
                      </div>

                      {/* Content */}
                      <div className="relative flex flex-col items-center justify-center p-5 mr-6 z-10">
                        {/* Traditional symbols */}
                ...
                >
                  <div className="relative">
                    <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-3xl bg-gradient-to-br from-pink-400 to-pink-600 shadow-xl flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-500">
                      {/* Background pattern */}
                      <div className="absolute inset-0 overflow-hidden rounded-3xl opacity-10">
                      ...
                      {/* Connector - enhanced with depth */}
                      <div className="absolute left-0 top-1/2 transform -translate-x-1/4 -translate-y-1/2 w-16 h-40 overflow-visible z-10">
                        <div className="absolute inset-0 bg-pink-500 rounded-r-2xl shadow-lg"></div>
                        <div className="absolute top-1/2 left-0 transform -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white rounded-full border-8 border-pink-500/80 shadow-lg z-20"></div>
                      </div>

                      {/* Content */}
                      <div className="relative flex flex-col items-center justify-center p-5 ml-6 z-10">
                        {/* Tech symbols */}
                        <div className="absolute opacity-10 inset-0 flex items-center justify-center">
                          <svg
                            width="120"
                        ...
                        <p className="text-pink-100 text-base md:text-lg text-center mb-5">
                          חדשנות, יעילות ודיוק
                        </p>
                        <div className="mt-2 flex flex-wrap justify-center gap-2">
                          <span className="px-3 py-1 bg-white/20 rounded-full text-sm text-white">
                ...
                <div
                  ...
                  style={{
                    ...
                    scale: 0.5 + puzzleAnim.progress * 1.5,
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div
                      ...
                      style={{
                        filter: `blur(${10 + puzzleAnim.progress * 15}px)`,
                        opacity: 0.8,
                      }}
                    ></div>
                    ...
                    <div className="absolute inset-0">
                      <div
                        className="absolute top-1/2 left-1/2 w-3 h-3 bg-cyan-400 rounded-full animate-ping"
                        style={{
                      ...
                      ></div>
                      <div
                        className="absolute top-1/2 left-1/2 w-3 h-3 bg-pink-400 rounded-full animate-ping"
                        style={{
                    ...
                    {/* Connected message */}
                    <div className="relative bg-gradient-to-r from-cyan-500 to-pink-500 text-white px-6 py-3 rounded-full shadow-lg whitespace-nowrap flex items-center gap-2">
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-4 bg-white/40 backdrop-blur-sm py-5 px-8 rounded-2xl shadow-lg">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <br />
                <span className="text-sm text-gray-600">זוגות מוצלחים</span>
              </div>
            </div>
