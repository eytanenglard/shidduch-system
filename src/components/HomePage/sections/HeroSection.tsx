...
import {
  ...
  // Link2 is not used by the original puzzle's center element, but good to have if needed later
} from "lucide-react";
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl aspect-square">
                ...
                <div
                  ...
                  style={{
                    transform: `translate(calc(-50% + ${puzzleAnim.progress * 50}px), -50%)`,
                  }}
                >
                  <div className="w-48 h-[18rem] sm:w-56 sm:h-[21rem] md:w-64 md:h-[24rem] lg:w-72 lg:h-[27rem] bg-gradient-to-br from-cyan-500 to-cyan-700 rounded-3xl shadow-xl p-4 sm:p-5 md:p-6 flex flex-col items-center justify-center text-white transform hover:scale-105 transition-transform">
                ...
                >
                   <div className="w-48 h-[18rem] sm:w-56 sm:h-[21rem] md:w-64 md:h-[24rem] lg:w-72 lg:h-[27rem] bg-gradient-to-br from-pink-500 to-pink-700 rounded-3xl shadow-xl p-4 sm:p-5 md:p-6 flex flex-col items-center justify-center text-white transform hover:scale-105 transition-transform">
                ...
                {/* Original Connection Animation (from user's puzzle code) */}
                <div
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-r from-cyan-500 to-pink-500 text-white px-4 sm:px-7 py-2.5 sm:py-3.5 rounded-full shadow-lg whitespace-nowrap flex flex-col items-center gap-1.5 sm:gap-2.5 text-center">
                        <div className="flex items-center gap-1.5 sm:gap-2.5">
                            <Heart className="w-4 h-4 sm:w-6 sm:h-6 fill-white animate-pulse" />
                            <span className="font-bold text-lg sm:text-xl md:text-2xl">Match Point</span>
                        </div>
                        <span className="text-sm sm:text-base md:text-base mt-1 leading-relaxed max-w-[200px] sm:max-w-[260px] md:max-w-sm">
