...
// Improvements: #49 logo hover text-teal-300 instead of orange-300
          ...
          <motion.div className="md:col-span-1" variants={logoVariants}>
            ...
            >
              <Link href="/" className="flex items-center gap-3 group mb-6">
                ...
                {/* #49: Logo hover updated to teal-300 for consistency */}
<span className="text-xl font-bold bg-gradient-to-r from-teal-300 via-orange-300 to-amber-300 text-transparent bg-clip-text">                  NeshamaTech
                </span>
              </Link>
            </motion.div>
