...
const PresentationTab: React.FC<PresentationTabProps> = ({
  ...
  return (
    <div className="bg-slate-50 min-h-[500px]">
      <div className="max-w-3xl mx-auto p-5 md:p-8 space-y-5 animate-in fade-in-0 slide-in-from-bottom-2 duration-300">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-5 md:p-6 flex flex-col justify-center">
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white shadow-md rounded-xl h-11 font-bold text-sm px-6"
              >
