      ...
      {!isHistory && (
        <CardFooter className="p-4 bg-gradient-to-r from-gray-50/50 to-slate-50/50 border-t border-gray-100">
          ...
          {suggestion.status === 'PENDING_FIRST_PARTY' && isFirstParty ? (
            ...
            isFirstParty ? (
            /* ═══════════════════════════════════════════════
               CASE: Second party not available - info only for first party
               ═══════════════════════════════════════════════ */
              ...
              <div className="flex items-start gap-2 px-3 py-3 bg-amber-50 rounded-xl border border-amber-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 mt-0.5">
                    {(dict.status as any)?.secondPartyNotAvailable
                      ?.description ||
                      (locale === 'he'
            ...
            !isFirstParty ? (
            /* ═══════════════════════════════════════════════
               CASE: Second party not available - action for second party
               ═══════════════════════════════════════════════ */
            <div className="w-full space-y-2">
              ...
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  // This calls the status change to PENDING_SECOND_PARTY
                  onApprove?.(suggestion);
                }}
              >
            ...
            isFirstParty ? (
            /* ═══════════════════════════════════════════════
               CASE: Re-offered to first party - full approve/decline
               ═══════════════════════════════════════════════ */
            <div className="w-full space-y-2">
