      ...
      >
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <div className="space-y-3 px-2">
            {/* Engagement Consent - FIX: Made entire row clickable */}
            <div
              role="button"
              tabIndex={0}
              onClick={() => {
                setEngagementConsent(!engagementConsent);
                if (!engagementConsent) setEngagementConsentError(null);
              }}
              onKeyDown={(e) => {
              ...
              className={`flex items-start gap-3 rounded-xl p-3 transition-colors cursor-pointer touch-manipulation active:bg-gray-100 select-none ${
            ...
            >
              <div className="flex items-center justify-center w-6 h-6 shrink-0 mt-0.5">
                <Checkbox
                  ...
                  className="touch-manipulation w-5 h-5 data-[state=checked]:bg-teal-600 data-[state=checked]:border-teal-600"
                />
              </div>
            ...
            {/* Promotional Consent - FIX: Made entire row clickable */}
            <div
              role="button"
              tabIndex={0}
              onClick={() => setPromotionalConsent(!promotionalConsent)}
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
              ...
              className="flex items-start gap-3 rounded-xl p-3 transition-colors cursor-pointer touch-manipulation active:bg-gray-100 hover:bg-gray-50 select-none"
            >
              <div className="flex items-center justify-center w-6 h-6 shrink-0 mt-0.5">
                <Checkbox
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="touch-manipulation w-5 h-5 data-[state=checked]:bg-orange-500 data-[state=checked]:border-orange-500"
                />
              </div>
              <div className="grid gap-1.5 leading-none flex-1">
