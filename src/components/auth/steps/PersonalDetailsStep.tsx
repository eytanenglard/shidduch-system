        ...
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              <Label htmlFor="firstNamePersonal" className="text-sm font-semibold text-gray-700 flex items-center">
              ...
              <FieldWrapper icon={<Edit3 className="h-5 w-5" />} hasValue={!!registrationState.firstName}>
                <Input
                  ...
                  className={`pr-11 py-3 border-2 rounded-xl transition-all bg-white/50 backdrop-blur-sm ${
                    firstNameError ? 'border-red-300 focus:border-red-400' : 'border-gray-200 focus:border-cyan-400'
            ...
            {/* Last Name */}
            <motion.div variants={itemVariants} className="space-y-2">
              <Label htmlFor="lastNamePersonal" className="text-sm font-semibold text-gray-700 flex items-center">
              ...
              <FieldWrapper icon={<Edit3 className="h-5 w-5" />} hasValue={!!registrationState.lastName}>
                <Input
                  ...
                  disabled={isLoading}
                  className={`pr-11 py-3 border-2 rounded-xl transition-all bg-white/50 backdrop-blur-sm ${
                    lastNameError ? 'border-red-300 focus:border-red-400' : 'border-gray-200 focus:border-cyan-400'
                  } focus:ring-2 focus:ring-cyan-200`}
                  dir={isRTL ? 'rtl' : 'ltr'}
                />
              </FieldWrapper>
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <div className={`rounded-xl ${phoneError ? 'ring-2 ring-red-300' : ''}`}>
                <PhoneNumberInput
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <span className="text-xl mr-2">👨</span> {personalDetailsDict.male}
                </Button>
                <Button
                  type="button"
                ...
                >
                   <span className="text-xl mr-2">👩</span> {personalDetailsDict.female}
                </Button>
              </div>
            </motion.div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Birth Date */}
                <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="birthDatePersonal" className="text-sm font-semibold text-gray-700 flex items-center">
                    ...
                    <FieldWrapper icon={<Calendar className="h-5 w-5" />} hasValue={!!registrationState.birthDate}>
                         <Input
                          ...
                          disabled={isLoading}
                          className={`pr-11 py-3 border-2 rounded-xl transition-all bg-white/50 backdrop-blur-sm ${
                            ageError ? 'border-red-300 focus:border-red-400' : 'border-gray-200 focus:border-cyan-400'
                          } focus:ring-2 focus:ring-cyan-200`}
                        />
                    </FieldWrapper>
                    {ageError && (
                ...
                <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="maritalStatusPersonal" className="text-sm font-semibold text-gray-700 flex items-center">
                        {personalDetailsDict.maritalStatusLabel} <span className="text-red-500 mr-1">*</span>
                    </Label>
                    <FieldWrapper icon={<Users className="h-5 w-5" />} hasValue={!!registrationState.maritalStatus}>
                         <select
          ...
          <div className="space-y-5">
            ...
            />
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Height */}
                <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="heightOptional" className="text-sm font-semibold text-gray-700 flex items-center gap-1">
                ...
                {/* Occupation */}
                <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="occupationOptional" className="text-sm font-semibold text-gray-700 flex items-center gap-1">
             ...
             {/* Education */}
             <motion.div variants={itemVariants} className="space-y-2">
                <Label htmlFor="educationOptional" className="text-sm font-semibold text-gray-700 flex items-center gap-1">
             ...
             <motion.div variants={itemVariants} className="space-y-2">
                ...
                <FieldWrapper icon={<BookOpen className="h-5 w-5" />} hasValue={!!registrationState.religiousLevel}>
                    <Select
                        ...
                        disabled={isLoading}
                    >
                        <SelectTrigger className={`w-full pr-11 pl-3 py-3 h-auto border-2 rounded-xl transition-all bg-white/50 backdrop-blur-sm ${
                             religiousLevelError ? 'border-red-300 focus:ring-red-200' : 'border-gray-200 hover:border-gray-300 focus:border-purple-400 focus:ring-2 focus:ring-purple-200'
                        }`}>
                 ...
                 <div className="flex items-start space-x-2 rtl:space-x-reverse">
                    ...
                    <div className="grid gap-1.5 leading-none">
                        ...
                        {engagementConsentError && (
                            <p className="text-xs text-red-500">{engagementConsentError}</p>
                        )}
                    </div>
                 </div>
