...
// הוספת שדה מותאם אישית ל-Candidate כדי למנוע שגיאות TS
...
// ============================================================================
// Minimal Compact Header Component (React.memo)
// ============================================================================
...
const CandidatesManager: React.FC<CandidatesManagerProps> = ({
  ...
  const [showBulkSuggestionsDialog, setShowBulkSuggestionsDialog] =
    useState(false);
  ...
  const comparisonAvatars = useMemo(() => {
    return Object.values(comparisonSelection).slice(0, 3);
  }, [comparisonSelection]);

  const comparisonCount = useMemo(
    () => Object.keys(comparisonSelection).length,
    [comparisonSelection]
  );

  // --- Effects (matchMedia instead of resize) ---
  useEffect(() => {
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3">
                ...
                <div className="flex items-center justify-between w-full md:w-auto md:justify-start gap-2 flex-wrap">
                  ...
                  >
                    ...
                    {isQuickViewEnabled
                      ? matchmakerDict.candidatesManager.controls
                          .disableQuickView
                      : matchmakerDict.candidatesManager.controls
                          .enableQuickView}
                  </Button>
