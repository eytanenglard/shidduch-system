...
const VALUE_EMAILS: ValueEmailContent[] = [
  {
    ...
    tips: {
      he: [
        { number: '1', title: 'אמון — הבסיס שאי אפשר בלעדיו', body: 'אמון לא מוכיחים במילים — מוכיחים בעקביות בין מה שאומרים למה שעושים. כבר בפגישות הראשונות אפשר לשים לב: האם הוא/היא הגיע/ה בזמן שאמר/ה? האם מה שסיפר/ה על עצמו/ה נשמע עקבי? סימנים קטנים מוקדמים אלו מדברים הרבה יותר משאלות ישירות על "ערכים".' },
        { number: '2', title: 'תקשורת — לא לדבר בשביל לדבר', body: 'מחקרים מגלים שזוגות מאושרים לא "מדברים" יותר — הם "מתקשרים" אחרת: מביעים צרכים בלי האשמות, ומקשיבים בלי לתכנן את התגובה בזמן שהאחר מדבר. בדייטים, שים לב: האם השיחה מרגישה שוויונית? האם הצד השני שואל, לא רק מדווח? זה מדד מדויק יותר מ"כיף".' },
        { number: '3', title: 'ערכים משותפים — המצפן המשותף', body: 'לא צריך להסכים על הכל — אבל על הדברים הגדולים חשוב לשאול מוקדם: ילדים, אורח חיים יהודי, יעדים בחיים, גישה לכסף. ערכים משותפים הם מה שמחזיק זוגות ביחד כשהחיים מביאים אתגרים — ואת ההלימה בנושאים אלה אפשר לחוש כבר בשיחות הראשונות.' },
      ],
      en: [
        { number: '1', title: 'Trust — The Foundation You Can\'t Do Without', body: 'Trust isn\'t proven in words — it\'s proven in consistency between what people say and what they do. Even in early meetings you can notice: Did they arrive when they said? Does what they shared about themselves sound consistent? These small early signs speak far more than direct questions about "values."' },
        { number: '2', title: 'Communication — Not Just Talking', body: 'Research shows that happy couples don\'t "talk" more — they communicate differently: expressing needs without blame, and listening without planning their response while the other is still speaking. On dates, notice: does the conversation feel equal? Does the other person ask questions, not just report? That\'s a more accurate measure than "fun."' },
        { number: '3', title: 'Shared Values — Your Shared Compass', body: 'You don\'t need to agree on everything — but on the big things it\'s worth asking early: children, Jewish lifestyle, life goals, approach to finances. Shared values are what hold couples together when life brings challenges — and alignment on these things can be sensed in the first conversations.' },
      ],
    },
    quoteText: {
...

  {
    ...
    headerSubtitle: { he: 'מה מחקר גוטמן גילה על תקשורת — ולמה זה חשוב לחיפוש שלך', en: 'What Gottman\'s research found about communication — and why it matters for your search' },
    introText: {
      he: 'ד"ר גוטמן חקר אלפי זוגות וגילה שהגורם מספר אחד לגירושים הוא לא בגידה ולא כסף — אלא דפוסי תקשורת לא בריאים שמצטברים. הממצא המפתיע שלו: את הדפוסים האלה אפשר לזהות כבר בשלבים מוקדמים. הנה שלושה דברים שכדאי להכיר לפני שמחפשים — ולשים לב אליהם בפגישות ראשונות.',
      en: 'Dr. Gottman studied thousands of couples and found that the number one cause of divorce isn\'t infidelity or money — but unhealthy communication patterns that accumulate. His surprising finding: these patterns can be identified from very early stages. Here are three things worth knowing before your search — and noticing on first dates.',
    },
    tips: {
      he: [
        { number: '1', title: '"אני" לא "אתה" — סימן לבשלות רגשית', body: 'אחד הדברים הכי חשובים לשים לב אליהם בדייט: כשמישהו מתאר מצב קשה — האם הוא/היא מדבר/ת על "אני הרגשתי..." או על "הם תמיד..." ו"כולם ככה"? אנשים שמביעים רגשות בשפת "אני" — לא מאשימים, לא תוקפים — מביאים את המיומנות הזו גם לזוגיות.' },
        { number: '2', title: 'הקשבה — מה שנדיר, ומה שרלוונטי', body: 'גוטמן גילה שזוגות מאושרים "מקשיבים" אחרת מזוגות אומללים: הם לא מתכננים תשובה בזמן שהצד השני מדבר. בפגישות ראשונות, שים לב: האם הוא/היא שואל/ת שאלות המשך? האם נזכרים בדברים שאמרת? הקשבה אמיתית היא מתנה נדירה — וניכרת מיד.' },
        { number: '3', title: 'מה שאמרת ≠ מה שנשמע — שווה לדעת', body: 'מחקרים מראים שאחד ממקורות הקונפליקטים הנפוצים ביותר בזוגות הוא פשוט: פרשנות שונה לאותן מילים. כשאתה/ת פוגש/ת מישהו שמוודא הבנה — "רגע, הבנתי נכון?" — זה סימן בוגר ומקצועי לתקשורת. שים לב אליו.' },
      ],
      en: [
        { number: '1', title: '"I" Not "You" — A Sign of Emotional Maturity', body: 'One of the most important things to notice on a date: when someone describes a difficult situation — do they speak about "I felt..." or about "they always..." and "everyone does this"? People who express feelings in "I" language — not blaming, not attacking — bring this skill to a relationship too.' },
        { number: '2', title: 'Listening — What\'s Rare, and What\'s Relevant', body: 'Gottman found that happy couples "listen" differently than unhappy ones: they don\'t plan a response while the other is speaking. On first dates, notice: do they ask follow-up questions? Do they remember things you said? Real listening is a rare gift — and it\'s immediately apparent.' },
        { number: '3', title: 'What You Said ≠ What Was Heard — Worth Knowing', body: 'Research shows that one of the most common sources of conflict in couples is simply: different interpretations of the same words. When you meet someone who verifies understanding — "Wait, did I understand correctly?" — that\'s a mature and skilled sign of communication. Notice it.' },
      ],
    },
    closingText: {
      he: 'תקשורת בריאה היא לא רק משהו שלומדים בזוגיות — אפשר לזהות אותה כבר בפגישה הראשונה. ב-NeshamaTech אנחנו מתאימים בין אנשים שדפוסי התקשורת שלהם מתחברים טבעית 💪',
      en: 'Healthy communication isn\'t only something you learn in a relationship — you can spot it on a first date. At NeshamaTech we match people whose communication patterns connect naturally 💪',
    },
...

  {
    ...
    headerSubtitle: { he: 'מה לחפש אצל מי שמחפשים לבנות בית יחד', en: 'What to look for in someone building a home together' },
    introText: {
      he: 'כשמישהו אומר "אני רוצה בית יהודי חם" — זה נשמע ברור. אבל איך מזהים את זה בפועל? מה הסימנים שמאותתים שהאדם שמולך אכן מחזיק בערכים שמרכיבים בית כזה? המסורת היהודית מגדירה שלושה עמודי תווך — ואפשר לזהות כל אחד מהם כבר בשיחות הראשונות.',
      en: 'When someone says "I want a warm Jewish home" — it sounds clear. But how do you recognize it in practice? What are the signs that signal the person across from you genuinely holds the values that make such a home? Jewish tradition defines three pillars — and each can be recognized in early conversations.',
    },
    tips: {
      he: [
        { number: '1', title: 'שלום בית — כיצד מזהים אדם שמחזיק בו', body: 'שלום בית אמיתי הוא לא היעדר מחלוקות — אלא בחירה מודעת לשים את הקשר מעל הצורך לנצח. שאל את עצמך בדייטים: כיצד מספר/ת הצד השני על קונפליקטים בחייו/ה — עם הורים, חברים, עמיתים? מי שרגיל "לנצח" בכל ויכוח — יביא את זה גם הביתה. מי שמחפש פתרון ולא ניצחון — זה הסימן.' },
        { number: '2', title: 'חסד — לתת בלי לספור', body: 'חסד הוא אחת המידות המגדירות את האופי היהודי — ובבית, הוא מתבטא בדברים הקטנים שלא מחכים לאירועים גדולים. בפגישה, שים לב: האם הצד השני שם לב לצרכים שלך? האם הוא/היא מציע/ה עזרה, מודה על קטנות, מתייחס/ת יפה למלצר? חסד יומיומי הוא הדלק של כל בית.' },
        { number: '3', title: 'שבת — יחס לזמן ולחיים ביחד', body: 'הדרך שבה מישהו מתייחס לשבת — ובאופן רחב יותר, לזמן איכות ולנוכחות — אומרת הרבה על הסדרי העדיפויות שלו. אדם שמסוגל להניח את הטלפון, להיות נוכח, ולהעניק תשומת לב מלאה — מביא את אותה יכולת לזוגיות. שאל: מה הוא/היא עושה עם הזמן החופשי?' },
      ],
      en: [
        { number: '1', title: 'Shalom Bayit — How to Recognize Someone Who Lives It', body: 'True Shalom Bayit isn\'t the absence of disagreements — it\'s a conscious choice to put the relationship above the need to win. Ask yourself on dates: How does this person describe conflicts in their life — with parents, friends, colleagues? Someone used to "winning" every argument will bring that home too. Someone who seeks resolution over victory — that\'s the sign.' },
        { number: '2', title: 'Chesed — Giving Without Counting', body: 'Chesed is one of the defining traits of Jewish character — and in a home, it\'s expressed in small things that don\'t wait for big occasions. On a date, notice: Is the other person attentive to your needs? Do they offer help, express gratitude for small things, treat the waiter kindly? Daily chesed is the fuel of every home.' },
        { number: '3', title: 'Shabbat — Attitude Toward Time and Being Together', body: 'How someone relates to Shabbat — and more broadly, to quality time and presence — says a lot about their priorities. A person able to put down their phone, be present, and give full attention — brings that same ability to a relationship. Ask: what does he/she do with free time?' },
      ],
    },
    quoteText: {
    ...
    closingText: {
      he: 'NeshamaTech מחברת אנשים שחולקים ערכים יהודיים ואורח חיים. בפרופיל שלך יש מקום לציין מה חשוב לך — ככל שתהיה מפורט/ת יותר, כך ההתאמה שלנו תהיה מדויקת יותר 🙏',
      en: 'NeshamaTech connects people who share Jewish values and a way of life. Your profile has space to indicate what\'s important to you — the more detailed you are, the more precise our matching will be 🙏',
    },
...

  {
    ...
    introText: {
      he: 'ד"ר ג\'ון גוטמן, מגדולי חוקרי הזוגיות בעולם, חקר למעלה מ-3,000 זוגות לאורך 40 שנה וגילה שיכול לחזות בדיוק של 93% אם זוג יתגרש — על סמך מדד אחד פשוט: היחס בין אינטראקציות חיוביות לשליליות. הנוסחה? 5 חיוביות על כל שלילית אחת. מה שמעניין הוא שהיחס הזה ניכר כבר בפגישות הראשונות — וזה אחד הדברים הכי שווה לשים לב אליהם.',
      en: 'Dr. John Gottman, one of the world\'s foremost relationship researchers, studied over 3,000 couples across 40 years and discovered he could predict with 93% accuracy whether a couple would divorce — based on one simple metric: the ratio of positive to negative interactions. The formula? 5 positive for every 1 negative. What\'s interesting is this ratio is visible even in early meetings — and it\'s one of the most worthwhile things to pay attention to.',
    },
    tips: {
      he: [
        { number: '1', title: 'מה זה אומר לגבי מי שמחפשים?', body: 'בדייטים, שים לב ליחס: האם האדם שמולך מדבר בעיקר על דברים שמטרידים אותו, מתלונן, מבקר? או שהוא/היא מביא/ה אנרגיה חיובית, שם לב לדברים הטובים, מחייך/ת? זה לא שכל אחד צריך להיות "שמח תמיד" — אלא שה"בסיס" של האדם, הברירת המחדל שלו, חשוב מאוד לאיכות החיים המשותפים.' },
        { number: '2', title: 'למה שלילי אחד שוקל כל כך הרבה?', body: 'המוח האנושי מעבד אירועים שליליים פי 5 חזק יותר מחיוביים — זו תכונה אבולוציונית. לכן גלגול עיניים אחד, הערה מזלזלת אחת, או ביקורת אחת על המלצר — "שוקלת" יותר מעשרה דברים נחמדים. שים לב לרגעים האלה — הם לא "מקרים". הם דפוס.' },
        { number: '3', title: 'מה לגבי עצמך?', body: 'שאלה שכדאי לשאול לפני שיוצאים לדייט: "האם אני מביא/ה אנרגיה חיובית? האם אני מסוגל/ת לשמח אחרים ולשים לב לטוב?" אנשים שמתרגלים חיוביות — עם חברים, משפחה, עמיתים — נכנסים לזוגיות עם יתרון משמעותי. זה שריר שאפשר לחזק.' },
      ],
      en: [
        { number: '1', title: 'What Does This Mean for Who You\'re Looking For?', body: 'On dates, notice the ratio: does the person across from you mostly talk about things that bother them, complain, criticize? Or do they bring positive energy, notice the good things, smile? It\'s not that everyone needs to be "always happy" — but their baseline, their default mode, matters enormously for shared quality of life.' },
        { number: '2', title: 'Why Does One Negative Weigh So Much?', body: 'The human brain processes negative events 5x more intensely than positive ones — an evolutionary trait. So one eye-roll, one dismissive comment, one criticism of the waiter — "weighs" more than ten nice things. Notice these moments — they\'re not "accidents." They\'re a pattern.' },
        { number: '3', title: 'What About Yourself?', body: 'A question worth asking before a date: "Am I bringing positive energy? Am I capable of uplifting others and noticing the good?" People who practice positivity — with friends, family, colleagues — enter a relationship with a significant advantage. It\'s a muscle that can be strengthened.' },
      ],
    },
    quoteText: {
    ...
    closingText: {
      he: 'היחס 5:1 הוא אחד הנתונים המדהימים ביותר בחקר הזוגיות. ב-NeshamaTech אנחנו מחפשים לך מישהו שה"בסיס" שלו מתאים לשלך — לא רק נתונים על הנייר. 🎯',
      en: 'The 5:1 ratio is one of the most fascinating findings in relationship research. At NeshamaTech we look for someone whose "baseline" matches yours — not just data on paper. 🎯',
    },
    ctaText: { he: 'לעדכן את הפרופיל שלי', en: 'Update My Profile' },
...

  {
    ...
    introText: {
      he: 'גוטמן גילה שהזוגיות לא נבנית ברגעים הדרמטיים — לא בחופה, לא בחופשה, ולא בשיחה עמוקה בשעות הלילה. היא נבנית ברגעים הקטנים: "תסתכל על השקיעה הזו" — ומישהו עוצר ומסתכל. גוטמן קרא לזה "פניות רגשיות" (Emotional Bids). הממצא המרתק: כיצד אדם מגיב לפניות כאלה כבר בדייטים הראשונים — מנבא טוב מה יהיה אחר כך.',
      en: 'Gottman discovered that relationships aren\'t built in dramatic moments — not at the wedding, not on vacation, not in late-night deep conversations. They\'re built in small moments: "look at that sunset" — and someone stops and looks. Gottman called these "Emotional Bids." The fascinating finding: how a person responds to these bids even on early dates — is a strong predictor of what will come later.',
    },
    tips: {
      he: [
        { number: '1', title: 'מה זו פנייה רגשית — ואיך מזהים אותה בדייט?', body: 'פנייה רגשית היא כל ניסיון ליצור חיבור — גדול או קטן. "תראה מה קרה לי היום", "אתה חייב לנסות את המנה הזו", חיוך חטוף כשמגיעים לנושא שמחבב. בדייט, שים לב: האם הצד השני שם לב לפניות שלך ועונה עליהן? או שהוא/היא מתעלם/ת, מחליף/ת נושא, ממשיך/ה לדבר?' },
        { number: '2', title: '86% לעומת 33% — המספרים שמדברים בעד עצמם', body: 'גוטמן גילה שזוגות שנשארו ביחד לאורך שנים פנו זה לזה ב-86% מהפניות הרגשיות. זוגות שהתגרשו — רק ב-33%. המשמעות: לא צריך "כימיה מיוחדת" — אלא מישהו שמסוגל לשים לב. אדם שמקשיב ונוכח בדייט — מביא את אותה יכולת לזוגיות.' },
        { number: '3', title: 'ומה לגבי עצמך?', body: 'כמה פעמים ביום מישהו פונה אליך — ואתה בטלפון? כמה פעמים מישהו מספר לך משהו — ואתה שומע רק חצי? היכולת "לפנות לעבר" — לתת נוכחות לאדם שמולך — היא אחת המיומנויות החשובות ביותר לזוגיות. ואפשר לפתח אותה כבר עכשיו, בחיי היום-יום.' },
      ],
      en: [
        { number: '1', title: 'What Is an Emotional Bid — and How to Spot It on a Date?', body: 'An emotional bid is any attempt to create connection — big or small. "Look what happened to me today," "you have to try this dish," a quick smile when reaching a topic they love. On a date, notice: does the other person pick up on your bids and respond? Or do they ignore, change the subject, keep talking?' },
        { number: '2', title: '86% vs. 33% — Numbers That Speak for Themselves', body: 'Gottman found that couples who stayed together over years turned toward each other in 86% of emotional bids. Divorced couples — only 33%. The meaning: you don\'t need "special chemistry" — you need someone capable of paying attention. A person who listens and is present on a date — brings that same ability to a relationship.' },
        { number: '3', title: 'What About You?', body: 'How many times a day does someone reach out to you — and you\'re on your phone? How many times does someone tell you something — and you only half-hear? The ability to "turn toward" — to give presence to the person in front of you — is one of the most important relationship skills. And it can be developed right now, in everyday life.' },
      ],
    },
    quoteText: {
    ...
    closingText: {
      he: 'נוכחות ותשומת לב — אלה לא "כלים לזוגיות" — הם גם מה שגורם לדייט להיות מוצלח. ב-NeshamaTech אנחנו מחפשים לך מישהו שמסוגל לראות אותך. 🎯',
      en: 'Presence and attention — these aren\'t just "relationship tools" — they\'re also what makes a date successful. At NeshamaTech we\'re looking for someone capable of truly seeing you. 🎯',
    },
    ctaText: { he: 'לראות את ההתאמות שלי', en: 'See My Matches' },
...

  {
    ...
    tips: {
      he: [
        ...
        { number: '3', title: 'התגוננות — "זה לא אני, זה אתה"', body: 'התגוננות היא תגובה טבעית לביקורת — אבל היא חוסמת כל אפשרות לפתרון. גוטמן מצא שזוגות מאושרים יודעים לשאול "מה החלק שלי בזה?" — גם כשקשה. בדייטים, שים לב: כשמישהו מדבר על קונפליקט שהיה לו — האם הוא/היא לוקח/ת אחריות כלשהי, או תמיד "הצד השני אשם"?' },
        { number: '4', title: 'הסתגרות — לבנות קירות', body: 'הסתגרות היא כשאדם "מתנתק" — מפסיק להגיב, יוצא מהחדר, או סוגר את עצמו. גוטמן גילה שזה בדרך כלל קורה מהצפה רגשית, לא מרוע לב. בדייטים: האם הצד השני מסוגל להמשיך שיחה גם כשהיא מעט קשה — או נסגר? זה מדד חשוב לבשלות רגשית.' },
      ],
      en: [
        { number: '1', title: 'Criticism — Attacking the Person, Not the Problem', body: 'Healthy critique is "I felt unheard in that conversation." Destructive criticism is "You always ignore me, you\'re so selfish." The difference? The first addresses a specific situation, the second attacks the person. On dates, notice: when someone describes a conflict they\'ve had — do they talk about specific situations, or do they attack the other person\'s character?' },
        { number: '2', title: 'Contempt — The Most Lethal Poison', body: 'Contempt is eye-rolling, cynicism, sarcasm, and disdain. Gottman calls it "the single strongest predictor of divorce." On dates, watch for subtle contempt: how does this person speak about their ex, their family, the waiter? Contempt toward others in conversation tends to eventually extend to a partner.' },
        { number: '3', title: 'Defensiveness — "It\'s Not Me, It\'s You"', body: 'Defensiveness blocks any possibility of resolution. Gottman found that happy couples know how to ask "what\'s my part in this?" — even when it\'s hard. On dates, notice: when someone talks about a conflict they\'ve had — do they take any responsibility, or is "the other side always guilty"?' },
        { number: '4', title: 'Stonewalling — Building Walls', body: 'Stonewalling is when a person "disconnects" — stops responding, leaves the room, or shuts down. Gottman found this usually happens from emotional flooding, not bad intent. On dates: is this person able to continue a conversation even when it gets slightly difficult — or do they shut down? It\'s an important measure of emotional maturity.' },
      ],
    },
    quoteText: {
...

  {
    ...
    emailNumber: '17',
    subject: {
      he: '5 שפות האהבה — מה שלך, ומה לחפש אצל בן/בת הזוג 💬',
      en: 'The 5 Love Languages — What\'s Yours, and What to Look For 💬',
    },
    headerEmoji: '💬',
    ...
    introText: {
      he: 'ד"ר גארי צ\'פמן, יועץ זוגיות עם למעלה מ-35 שנות ניסיון, גילה שכל אדם "מדבר" אהבה בשפה שונה. הרעיון הזה — 5 שפות האהבה — הפך לאחד הכלים השימושיים ביותר בהבנה עצמית לפני זוגיות. כשיודעים מה השפה שלך, יודעים מה אתה/ת צריך/ה מבן/בת זוג — וגם מה חשוב לך לתת.',
      en: 'Dr. Gary Chapman, a relationship counselor with over 35 years of experience, discovered that every person "speaks" love in a different language. This idea — 5 love languages — has become one of the most useful tools for self-understanding before a relationship. When you know your language, you know what you need from a partner — and what you naturally give.',
    },
    tips: {
      he: [
        { number: '1', title: 'מילים מעודדות — מי שצריך לשמוע', body: 'אנשים ששפת האהבה שלהם היא מילים — זקוקים לשמוע מחמאות, הערכה, ועידוד מילולי. בשבילם, "אני גאה בך" שווה יותר ממתנה יקרה. בדייט, שים לב: כשאתה/ת אומר/ת משהו נחמד — האם הצד השני מגיב? האם גם הוא/היא שולח/ת מחמאות? זה יכול לגלות הרבה על השפה שלו/ה.' },
        { number: '2', title: 'זמן איכות — מי שצריך נוכחות', body: 'אנשים ששפת האהבה שלהם היא זמן איכות — נוכחות מלאה ללא הסחות דעת היא מה שמרגיש להם כאהבה. לא מספיק "להיות ביחד" — צריך להיות נוכח. אם אתה/ת מאדם כזה — ואת/ה מולך מישהו שבטלפון כל הדייט — זו לא "גסות רוח" גרידא. זו אי-תאימות בשפה.' },
        { number: '3', title: 'מגע פיזי / מתנות / מעשי שירות — שלוש שפות נוספות', body: 'מגע פיזי: מי שצריך חיבוק, יד על הכתף, מגע חם. מתנות: לא בהכרח יקרות — אלא מחושבות ואישיות. מעשי שירות: מי שמרגיש אהבה כשמישהו עושה בשבילו בלי שביקש. הכרת השפה שלך עוזרת לך לתאר בפרופיל מה חשוב לך — ולנו לחפש לך מישהו שמדבר אותה.' },
        { number: '4', title: 'איך לגלות את השפה שלך', body: 'שאל את עצמך: "מה הכי כואב לי כשחסר? מה הכי ממלא אותי כשאני מקבל?" אם חסרות לך מילים טובות — כנראה שזו השפה שלך. אם הכי כואב לך שמבטלים תוכניות — זמן איכות הוא השפה שלך. הבנה עצמית מדויקת = הפרופיל שלך יהיה מדויק יותר = ההתאמה תהיה טובה יותר.' },
      ],
      en: [
        { number: '1', title: 'Words of Affirmation — Those Who Need to Hear It', body: 'People whose love language is words need to hear compliments, appreciation, and verbal encouragement. For them, "I\'m proud of you" is worth more than an expensive gift. On a date, notice: when you say something nice — does the other person respond? Do they also give compliments? This can reveal a lot about their language.' },
        { number: '2', title: 'Quality Time — Those Who Need Presence', body: 'People whose love language is quality time feel love through full, undistracted presence. Being "together" isn\'t enough — they need genuine presence. If you\'re this kind of person — and the person across from you is on their phone throughout the date — it\'s not just "rudeness." It\'s a language mismatch.' },
        { number: '3', title: 'Physical Touch / Gifts / Acts of Service — Three More Languages', body: 'Physical touch: those who need a hug, a hand on the shoulder, warm contact. Gifts: not necessarily expensive — thoughtful and personal. Acts of service: those who feel love when someone does things for them without being asked. Knowing your language helps you describe in your profile what matters to you — and helps us find someone who speaks it.' },
        { number: '4', title: 'How to Discover Your Language', body: 'Ask yourself: "What hurts most when it\'s missing? What fills me up most when I receive it?" If you miss kind words — that\'s probably your language. If canceled plans hurt most — quality time is your language. Accurate self-understanding = more accurate profile = better matching.' },
      ],
    },
    quoteText: {
...

  {
    ...
    emailNumber: '18',
    subject: {
      he: 'הממצא המפתיע: הדבר שמנבא הצלחה בזוגיות יותר מכל דבר אחר 🙏',
      en: 'The Surprising Finding: What Predicts Relationship Success More Than Anything 🙏',
    },
    headerEmoji: '🙏',
    headerTitle: { he: 'כוח ההכרת תודה', en: 'The Power of Gratitude' },
    headerSubtitle: { he: 'מה מחקר של 9 חודשים גילה — ומה זה אומר לחיפוש שלך', en: 'What a 9-month study revealed — and what it means for your search' },
    introText: {
      he: 'מחקר שפורסם ב-Journal of Personality and Social Psychology עקב אחרי זוגות לאורך 9 חודשים ומצא ממצא מפתיע: הגורם שהשפיע הכי הרבה על שביעות הרצון בזוגיות לא היה תקשורת, לא כסף, ולא מין — אלא הכרת תודה. זוגות שהביעו תודה באופן קבוע דיווחו על שביעות רצון גבוהה ב-25% ועל מחויבות גבוהה ב-30%. מה זה אומר לגבי מה לחפש — ומה לפתח בעצמך?',
      en: 'A study published in the Journal of Personality and Social Psychology tracked couples over 9 months and found a surprising result: the factor that most influenced relationship satisfaction wasn\'t communication, money, or sex — it was gratitude. Couples who regularly expressed gratitude reported 25% higher satisfaction and 30% higher commitment. What does this mean for what to look for — and what to develop in yourself?',
    },
    tips: {
      he: [
        { number: '1', title: 'מה מחקר גוטמן גילה על הכרת תודה בדייטים?', body: 'גוטמן גילה שאנשים בעלי "הכרת תודה טבעית" — שמים לב לטוב, מודים על דברים קטנים, מתפעלים — בונים קשרים מוצלחים יותר. בדייט, שים לב: האם הצד השני מדבר על דברים שמכירים לו לטובה? האם הוא/היא מוקיר/ה דברים קטנים — שרות טוב, מזג אוויר נחמד, מחשבה שהבאת? זה לא "קלישאה" — זה מדד אמיתי.' },
        { number: '2', title: 'תודה ספציפית > תודה כללית — לדעת לגלות', body: 'מחקר מאוניברסיטת ג\'ורג\'יה גילה שתודה ספציפית — כזו שמציינת מה בדיוק עשה הצד השני ואיך זה השפיע — חזקה פי 3 מתודה כללית. בדייטים, ניתן לראות זאת: האם כשאדם מודה — זה כללי ("תודה רבה") או ספציפי ("תודה שהגעת בדיוק בזמן, זה גרם לי להרגיש שנוח לך להיות כאן")? הספציפיות מלמדת על מודעות.' },
        { number: '3', title: 'תרגיל מומלץ לשלב הדייטים: "3 דברים טובים"', body: 'מרטין סליגמן, אבי הפסיכולוגיה החיובית, גילה שכתיבת 3 דברים טובים שקרו ביום — יחד עם הסבר למה — מעלה רמות אושר תוך שבוע, עם השפעה שנמשכת חודשים. בשלב החיפוש, כשהתהליך לפעמים מתסכל — תרגיל כזה עוזר לשמור על גישה חיובית ורואה-טוב שמושכת אנשים טובים.' },
      ],
      en: [
        { number: '1', title: 'What Gottman Found About Gratitude on Dates', body: 'Gottman found that people with natural "gratitude tendencies" — who notice the good, thank for small things, express appreciation — build more successful relationships. On a date, notice: does the other person speak about things they\'re grateful for? Do they appreciate small things — good service, nice weather, a thoughtful gesture you made? This isn\'t "cliché" — it\'s a real indicator.' },
        { number: '2', title: 'Specific Gratitude > General Gratitude — Learning to Spot It', body: 'Research from the University of Georgia found that specific gratitude — naming exactly what the other person did and how it affected you — is 3x more powerful than general thanks. On dates, you can see this: when someone thanks — is it general ("thanks so much") or specific ("thank you for arriving exactly on time, it made me feel comfortable being here")? Specificity reveals awareness.' },
        { number: '3', title: 'Recommended Exercise for the Dating Stage: "3 Good Things"', body: 'Martin Seligman, father of positive psychology, found that writing 3 good things that happened each day — along with why they happened — raises happiness levels within a week, with effects lasting months. During the search phase, when the process is sometimes frustrating — this exercise helps maintain a positive, good-seeing approach that attracts good people.' },
      ],
    },
    quoteText: {
    ...
    closingText: {
      he: 'הכרת תודה היא לא רק מידה טובה — היא מנבא מדעי לאושר בזוגיות. כשתמצא/י מישהו שרואה את הטוב — וגם אתה/ת מביא/ה את הגישה הזו — יש לכם יסוד חזק. 🎯',
      en: 'Gratitude isn\'t just a good trait — it\'s a scientific predictor of relationship happiness. When you find someone who sees the good — and you bring that approach too — you have a strong foundation. 🎯',
    },
    ctaText: { he: 'לבדוק את הפרופיל שלי', en: 'Check My Profile' },
...

  {
    ...
    tips: {
      he: [
        { number: '1', title: 'קונפליקטים "נצחיים" vs. "ניתנים לפתרון" — ההבדל חיוני', body: 'קונפליקט ניתן לפתרון הוא על מצב ספציפי: "איפה מבלים את החגים?" — ניתן לפתרון. קונפליקט נצחי הוא על הבדל בסיסי באישיות: אחד מסודר, השני ספונטני. אחד חסכן, השני נדיב. אלה לא בעיות לתקן — אלה הבדלים לנהל. המפתח: לא להפוך הבדל בסיסי לקרב קיום — וחשוב לזהות מה הסוג לפני שמחליטים.' },
        { number: '2', title: 'מה גוטמן גילה על איך זוגות מאושרים מתמודדים עם הבדלים', body: 'גוטמן גילה שזוגות מאושרים ואומללים מתמודדים עם אותן בעיות בדיוק — אבל בצורה שונה לגמרי. זוגות מאושרים: מוסיפים הומור, מביעים הבנה לנקודת המבט של הצד השני, שומרים על כבוד גם כשנחושים. זוגות אומללים: תוקפים, מבזים, מתגוננים — ה"ארבעה פרשים". המסקנה: השאלה החשובה היא לא "האם יש הבדלים?" אלא "כיצד שניהם מתמודדים איתם?"' },
        { number: '3', title: 'השאלות הנכונות לשאול לפני שמחליטים', body: 'כדאי לשאול את עצמך בשלב ההיכרות: "מה ההבדלים הבסיסיים בין הצד השני לביני? האם אני מסוגל לחיות עם ההבדלים האלה בכבוד ובהומור?" לא "האם ההבדלים האלה יעלמו?" — כי הם לא. אלא "האם אני מוכן להחזיק את ההבדלים האלה בידיים טובות?" זו שאלת הבגרות הזוגית.' },
        { number: '4', title: 'המשמעות לשידוכים: "תאימות" לא אומרת "זהות"', body: 'הטעות הנפוצה ביותר בחיפוש שידוך: לחפש מישהו שהכל בו זהה. גוטמן מלמד שזה לא רק בלתי-אפשרי — זה גם לא רצוי. ההבדלים בין שני אנשים יוצרים עניין, צמיחה, ועושר. השאלה אינה "האם הכל זהה?" אלא "האם שני הצדדים מכבדים את ההבדלים שביניהם?" — וזה משהו שאפשר לבחון כבר בשיחות הראשונות.' },
      ],
      en: [
        { number: '1', title: '"Perpetual" vs. "Solvable" Conflicts — A Crucial Distinction', body: 'A solvable conflict is about a specific situation: "Where will we spend the holidays?" — solvable. A perpetual conflict is about a fundamental personality difference: one is tidy, the other spontaneous. One is frugal, the other generous. These aren\'t problems to fix — they\'re differences to manage. The key: don\'t turn a fundamental difference into an existential battle — and it\'s important to identify which type you\'re dealing with before deciding.' },
        { number: '2', title: 'What Gottman Found About How Happy Couples Handle Differences', body: 'Gottman found that happy and unhappy couples deal with the exact same problems — but in completely different ways. Happy couples: add humor, express understanding for the other\'s perspective, maintain respect even when determined. Unhappy couples: attack, demean, become defensive — the "Four Horsemen." The conclusion: the important question isn\'t "Are there differences?" but "How do both people handle them?"' },
        { number: '3', title: 'The Right Questions to Ask Before Deciding', body: 'Worth asking yourself during the getting-to-know stage: "What are the fundamental differences between the other person and me? Am I able to live with these differences with respect and humor?" Not "Will these differences disappear?" — because they won\'t. But "Am I willing to hold these differences with good hands?" That\'s the question of relationship maturity.' },
        { number: '4', title: 'The Implication for Dating: "Compatibility" Doesn\'t Mean "Identical"', body: 'The most common mistake in searching for a match: looking for someone identical in everything. Gottman teaches that this is not only impossible — it\'s not even desirable. The differences between two people create interest, growth, and richness. The question isn\'t "Is everything identical?" but "Do both people respect the differences between them?" — and that\'s something you can observe even in the first conversations.' },
      ],
    },
    quoteText: {
...

  {
    ...
    headerEmoji: '🏦',
    headerTitle: { he: 'חשבון הבנק הרגשי — מה גוטמן גילה על בניית אמון', en: 'The Emotional Bank Account — What Gottman Found About Building Trust' },
    headerSubtitle: { he: 'הכלי שמסביר למה בחירות קטנות יומיומיות חשובות יותר ממחוות גדולות', en: 'The tool that explains why small daily choices matter more than grand gestures' },
    introText: {
      he: 'גוטמן פיתח מטפורה שהפכה לאחד הכלים החינוכיים החשובים ביותר בפסיכולוגיית הזוגיות: "חשבון הבנק הרגשי". כמו חשבון בנק רגיל — יש בו הפקדות ומשיכות. ביחסים בריאים, ישנה יתרת הפקדות קבועה שנבנית בזמן שהכל טוב — ומחזיקה את הקשר כשמגיעות הסערות. ומה שמרתק? אפשר לראות סימנים של המטפורה הזו כבר בפגישות הראשונות.',
      en: 'Gottman developed a metaphor that became one of the most important educational tools in relationship psychology: the "Emotional Bank Account." Like a regular bank account — it has deposits and withdrawals. In healthy relationships, there\'s a consistent positive balance that builds when things are good — and holds the relationship when storms arrive. And what\'s fascinating? You can see signs of this metaphor already in the first meetings.',
    },
    tips: {
      he: [
        { number: '1', title: 'הפקדות — מה לשים לב אליו כבר מהפגישה הראשונה', body: 'הפקדות רגשיות הן: לזכור פרטים קטנים שסיפרו לך ולשאול המשך ("איך יצא לך הראיון שדיברת עליו?"), להגיב בחום על מה שמשתפים, להודות על משהו ספציפי, להיות נוכח בשיחה — לא שקוע בטלפון. בדייטים, שים/שימי לב: האם הצד השני זוכר פרטים שסיפרת בפגישה הקודמת? האם הוא/היא שואל/ת שאלות המשך? אנשים שעושים זאת באופן טבעי — זה לא "מהלך", זה אופי.' },
        { number: '2', title: 'משיכות — הסימנים שכדאי להכיר מוקדם', body: 'משיכות גדולות: ביקורת, בוז, שיפוטיות גלויה כלפי אחרים. משיכות קטנות אך מצטברות: לבדוק את הטלפון בזמן שיחה, להתעלם מדברים שאמרת, לענות "מה?" בטון קצר, לא לשאול שאלות. עשר "משיכות" קטנות יכולות לנקז יתרה שנבנתה על ידי חמישים פגישות טובות. שים/שימי לב לפרטים הקטנים — הם מספרים הרבה.' },
        { number: '3', title: 'האסימטריה שכדאי להבין לפני שמחפשים זוגיות', body: 'הפסיכולוגיה מלמדת: הכאב "שוקל" יותר מהנחמה. חוויה שלילית אחת שקולה בתחושה לחמש חוויות חיוביות — זה נקרא "הטיית השליליות". לכן בתהליך ההיכרות: הרבה פגישות חמות ומהנות לא מוחקות פגישה אחת שהרגשת בה פגוע/ה. ואדם שמשחיל הרבה הפקדות קטנות עקביות — בונה חשבון שיחזיק גם ברגעים קשים.' },
        { number: '4', title: 'תרגיל: להתחיל לבנות את הכישרון הזה — עכשיו', body: 'כישרון ה"הפקדות הרגשיות" הוא מיומנות שאפשר לפתח עוד לפני הדייטים — עם כל אדם בחיים שלך: חבר, הורה, עמית. תחל בשאלה אמיתית אחת ביום לאדם קרוב — "מה הכי העסיק אותך היום?" — ושים/שימי לב מה זה עושה לקשר. אנשים שמגיעים לדייטים עם הרגל הזה — מיד מורגש שהם נוכחים, קשובים, ומשאירים רושם שונה.' },
      ],
      en: [
        { number: '1', title: 'Deposits — What to Notice From the Very First Meeting', body: 'Emotional deposits are: remembering small details you were told and asking follow-up ("How did that interview you mentioned go?"), responding warmly to what\'s shared, thanking for something specific, being present in conversation — not buried in a phone. On dates, notice: does the other person remember details you shared last time? Do they ask follow-up questions? People who do this naturally — it\'s not a "move," it\'s character.' },
        { number: '2', title: 'Withdrawals — Signs Worth Recognizing Early', body: 'Large withdrawals: criticism, contempt, open judgment of others. Small but cumulative withdrawals: checking the phone during conversation, ignoring things you said, answering "what?" in a short tone, not asking questions. Ten small "withdrawals" can drain a balance built by fifty good meetings. Pay attention to the small details — they tell a lot.' },
        { number: '3', title: 'The Asymmetry Worth Understanding Before Searching for a Relationship', body: 'Psychology teaches: pain "weighs" more than comfort. One negative experience equals five positive ones in felt weight — this is called "negativity bias." So in the getting-to-know process: many warm and enjoyable meetings don\'t erase one meeting where you felt hurt. And a person who consistently makes many small deposits — builds an account that will hold even in difficult moments.' },
        { number: '4', title: 'Exercise: Start Building This Skill — Now', body: 'The skill of "emotional deposits" can be developed before dating — with every person in your life: friends, parents, colleagues. Start with one genuine question per day to someone close — "What took up most of your mind today?" — and notice what it does to the connection. People who arrive at dates with this habit — you immediately feel they\'re present, attentive, and leave a different impression.' },
      ],
    },
    quoteText: {
...

  {
    ...
    emailNumber: '26',
    subject: {
      he: 'מה אנשים בוגרים עושים אחרי ויכוח — הממצא שגוטמן גילה ב-40 שנות מחקר 🛠️',
      en: 'What Mature People Do After an Argument — Gottman\'s Finding From 40 Years of Research 🛠️',
    },
    headerEmoji: '🛠️',
    headerTitle: { he: 'ניסיונות תיקון — סימן הבגרות שגוטמן חיפש', en: 'Repair Attempts — The Maturity Signal Gottman Looked For' },
    headerSubtitle: { he: 'זוגות מאושרים לא נלחמים פחות — הם מתקנים טוב יותר. מה זה אומר לגביך?', en: 'Happy couples don\'t fight less — they repair better. What does that mean for you?' },
    introText: {
      he: 'גוטמן עקב אחרי זוגות במשך ארבעים שנה. אחד הממצאים המפתיעים ביותר: זוגות מאושרים לא נלחמים פחות — הם מתקנים טוב יותר. הוא הגדיר "ניסיון תיקון" כ"כל אמירה או פעולה שמונעת מהשליליות להסלים" — הומור, הכרה בטעות, הצעת הפסקה, מחווה חמה. ואמר שכישלון ניסיונות התיקון הוא "אחד המנבאים האמינים ביותר לפירוק זוגיות". המסקנה שלו? מה שמבחין אדם בוגר הוא לא שהוא לא כועס — אלא שהוא יודע לחזור.',
      en: 'Gottman followed couples for forty years. One of the most surprising findings: happy couples don\'t fight less — they repair better. He defined a "repair attempt" as "any statement or action that prevents negativity from escalating" — humor, acknowledging a mistake, suggesting a break, a warm gesture. And he said that the failure of repair attempts is "one of the most reliable predictors of relationship dissolution." His conclusion? What distinguishes a mature person is not that they don\'t get angry — but that they know how to come back.',
    },
    tips: {
      he: [
        { number: '1', title: 'מה נחשב "ניסיון תיקון" — ואיך מזהים אותו', body: 'ניסיון תיקון יכול להיות: הומור עצמי ("אנחנו שניינו כל-כך מוצלחים בזה..."), הכרה ("את/ה צודק/ת, לא שמעתי טוב"), הצעת הפסקה ("אני צריך כמה דקות, ואז אחזור"), מחווה ("אביא לך משהו לשתות"), או שאלה פותחת ("רגע — בואו נתחיל מחדש. מה בעצם צריך כאן?"). אלה לא חולשה — אלה סימן של בינה רגשית גבוהה.' },
        { number: '2', title: 'מה ניסיונות תיקון מגלים על אדם — כבר בשלב ההיכרות', body: 'כבר בפגישות הראשונות, לפעמים עולים חיכוכים קטנים — פרשנות שגויה, הערה שלא נחתה טוב, אי-הבנה. שים/שימי לב: כיצד הצד השני מגיב? האם הוא/היא מקשה ומסלים — או מגלה גמישות ומחפש/ת לתקן? אדם שיודע להגיד "סליחה, כנראה לא ניסחתי טוב" כבר בפגישה שנייה — מראה כישרון שחיוני לכל זוגיות לטווח ארוך.' },
        { number: '3', title: 'למה ניסיונות תיקון לא תמיד עובדים — ומה לומדים מזה', body: 'ניסיון תיקון עובד רק אם יש מספיק "יתרה" של אמון. אם ה"חשבון" כבר בעומק מינוס — אפילו ניסיון כן מתקבל בחשד: "אתה/את רק מנסה לברוח מהנושא." לכן גוטמן מדגיש: ניסיונות תיקון לא עובדים לבד — הם פועלים על בסיס הפקדות יומיומיות קטנות שנצטברו לאורך זמן. אפשר לנסות לתקן — אבל אם לא בנית קרבה, התיקון לא "יאחז".' },
        { number: '4', title: 'תרגיל: לבנות את הכישרון הזה — עכשיו', body: 'חשוב/י על ויכוח שהיה לך לאחרונה — עם חבר, הורה, עמית עבודה. מה עשית? ברחת? נסגרת? האשמת? עכשיו שאל/י: מה יכולת להגיד שהיה "ניסיון תיקון"? כתוב/כתבי שלוש תשובות אפשריות. אנשים שמתרגלים את הכישרון הזה עם כל מי שסביבם — מגיעים לדייטים עם יכולת שרוב האנשים לומדים רק אחרי שנים של נישואים.' },
      ],
      en: [
        { number: '1', title: 'What Counts as a "Repair Attempt" — And How to Recognize It', body: 'A repair attempt can be: self-deprecating humor ("We\'re both so excellent at this..."), acknowledgment ("You\'re right, I didn\'t listen well"), suggesting a break ("I need a few minutes, then I\'ll come back"), a gesture ("Let me get you something"), or an opening question ("Wait — let\'s start over. What does this really need?"). These aren\'t weakness — they\'re signs of high emotional intelligence.' },
        { number: '2', title: 'What Repair Attempts Reveal About a Person — Even in Early Meetings', body: 'Even in early meetings, small frictions sometimes arise — a misinterpretation, a comment that didn\'t land well, a misunderstanding. Notice: how does the other person respond? Do they harden and escalate — or show flexibility and try to repair? A person who can say "Sorry, I probably didn\'t phrase that well" already in the second meeting — shows a skill essential to any long-term relationship.' },
        { number: '3', title: 'Why Repair Attempts Don\'t Always Work — And What to Learn From That', body: 'A repair attempt only works if there\'s enough "balance" of trust. If the "account" is already deeply in deficit — even a sincere attempt is received with suspicion: "You\'re just trying to escape the topic." That\'s why Gottman emphasizes: repair attempts don\'t work alone — they work on a foundation of small daily deposits accumulated over time. You can try to repair — but if you haven\'t built closeness, the repair won\'t "stick."' },
        { number: '4', title: 'Exercise: Build This Skill — Now', body: 'Think of a recent argument you had — with a friend, parent, work colleague. What did you do? Did you flee? Shut down? Blame? Now ask: what could you have said that would have been a "repair attempt"? Write three possible answers. People who practice this skill with everyone around them — arrive at dates with an ability that most people only develop after years of marriage.' },
      ],
    },
    quoteText: {
...

  {
    ...
    emailNumber: '27',
    subject: {
      he: 'מפות אהבה — הכישרון שמבדיל דייט שטחי מהיכרות אמיתית 🗺️',
      en: 'Love Maps — The Skill That Separates a Shallow Date From a Real Connection 🗺️',
    },
    headerEmoji: '🗺️',
    headerTitle: { he: 'מפות אהבה — Love Maps', en: 'Love Maps — The Art of Truly Knowing Someone' },
    headerSubtitle: { he: 'מה גוטמן גילה על אנשים שבונים זוגיות שעומדת במשברים', en: 'What Gottman found about people who build relationships that withstand crises' },
    introText: {
      he: 'הקומה הראשונה ב"בית הזוגיות" של גוטמן — הבסיס של כל השאר — נקראת "מפות אהבה". לא מפות גאוגרפיות. מפות של העולם הפנימי של אדם: החלומות שלו, פחדיה, הזיכרונות שעיצבו אותו, האנשים שחשובים לה, מה שמחולל שמחה, מה שמכביד בלילה. ככל שאתה בונה מפת אהבה מפורטת יותר של מי שאתה פוגש/ת — כך אתה מסוגל/ת להכיר אותו/ה לעומק ולהחליט אם מה שיש שם יכול להפוך למשהו אמיתי.',
      en: 'The first floor of Gottman\'s "Relationship House" — the foundation of everything else — is called "Love Maps." Not geographical maps. Maps of a person\'s inner world: his dreams, her fears, the memories that shaped him, the people important to her, what creates joy, what weighs heavy at night. The more detailed a love map you build of someone you\'re meeting — the more capable you are of truly knowing them and deciding if what\'s there can become something real.',
    },
    tips: {
      he: [
        { number: '1', title: 'מה גוטמן גילה על מפות אהבה', body: 'גוטמן גילה שזוגות שחוו משברים חיצוניים — מחלה, פיטורים, אבדן — שרדו הרבה יותר טוב כשהיו להם "מפות אהבה" מפורטות. הסיבה: כשמכירים לעומק את העולם הפנימי של אדם — מבינים את ההתנהגות שלו/ה בזמן לחץ, במקום לפרש אותה כהתקפה. "הוא נסגר כי הוא פוחד" — לא "הוא נסגר כי לא אכפת לו ממני". ובשלב הדייטים: אנשים שמוכנים לשאול שאלות אמיתיות — מגלים מה שנמצא מתחת לפני השטח.' },
        ...
        { number: '4', title: 'הקשר למסורת היהודית: "שמע ישראל"', body: 'הציווי המרכזי ביותר ביהדות הוא שמיעה — "שמע". לדעת את האחר פירושו קודם כל להקשיב לו. המסורת היהודית מלמדת שידיעת אדם — כבוד הבריות — היא ערך עמוק. כבר בדייטים, הכישרון לשמוע באמת ולא רק לחכות לתורך לדבר — הוא אחד הדברים הנדירים ביותר ואחד הדברים שמשאירים רושם עמוק ביותר. "שמע" — לא רק מצווה, גם כלי הכרות.' },
      ],
      en: [
        { number: '1', title: 'What Gottman Discovered About Love Maps', body: 'Gottman found that couples who experienced external crises — illness, job loss, bereavement — survived much better when they had detailed "love maps." The reason: when you truly know someone\'s inner world — you understand their behavior under stress, instead of interpreting it as an attack. "He shut down because he\'s scared" — not "He shut down because he doesn\'t care about me." On dates: people who ask real questions discover what lies beneath the surface.' },
        ...
        { number: '4', title: 'The Jewish Connection: "Shema Yisrael"', body: 'The most central commandment in Judaism is hearing — "Shema." To know another person means first to listen to them. Jewish tradition teaches that knowing a person — kavod habriyot — is a deep value. Already on dates, the skill of truly listening — not just waiting for your turn to speak — is one of the rarest things and one of the things that leaves the deepest impression. "Shema" — not just a commandment, but a tool for truly getting to know someone.' },
      ],
    },
    quoteText: {
