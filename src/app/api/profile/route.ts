...
export async function GET(req: Request) {
  try {
    ...
    const profileResponseData: UserProfile = {
      ...
      aliyaCountry: dbProfile.aliyaCountry ?? null,
      ...
      fatherOccupation: dbProfile.fatherOccupation ?? null,
      motherOccupation: dbProfile.motherOccupation ?? null,
      ...
      education: dbProfile.education ?? null,
      occupation: dbProfile.occupation ?? null,
      serviceType: dbProfile.serviceType as ServiceType | null || undefined,
      serviceDetails: dbProfile.serviceDetails ?? null,
      ...
      about: dbProfile.about ?? null,
      profileHeadline: dbProfile.profileHeadline ?? null,
      humorStory: dbProfile.humorStory ?? null,
      inspiringCoupleStory: dbProfile.inspiringCoupleStory ?? null,
      influentialRabbi: dbProfile.influentialRabbi ?? null,
      matchingNotes: dbProfile.matchingNotes ?? null,
      ...
      availabilityNote: dbProfile.availabilityNote ?? null,
      ...
      user: {
        ...
        console.log('---[ API SERVER LOG ]--- Sending Profile Data to Client:');
    console.log(JSON.stringify(profileResponseData, null, 2));
