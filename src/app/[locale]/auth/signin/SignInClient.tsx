...
const AppleLogo: React.FC<{ className?: string }> = ({ className = 'h-5 w-5' }) => (
            ...
            <div className="relative z-10 p-6 sm:p-8">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  disabled={isAnyLoading}
                  className="w-full relative z-20 py-4 rounded-xl flex items-center justify-center gap-3 group transition-all duration-200 bg-black hover:bg-gray-900 text-white shadow-lg hover:shadow-xl touch-manipulation active:scale-[0.98] border-0"
                >
                  {isAppleLoading ? (
                    <>
                      <Loader2 className="animate-spin h-5 w-5" />
                      <span className="font-medium">
                        {dict.appleButtonLoading || (locale === 'he' ? 'מתחבר עם Apple...' : 'Signing in with Apple...')}
                      </span>
                    </>
                  ) : (
                    <>
                      ...
                      <span className="font-medium">
                        {dict.appleButton || (locale === 'he' ? 'התחברות עם Apple' : 'Sign in with Apple')}
                      </span>
                    </>
                  )}
                </Button>
