...
const TermsOfServiceClient: React.FC<TermsOfServiceClientProps> = ({
  dict,
  locale,
}) => {
      ...
      <div className="bg-gradient-to-br from-cyan-50 via-white to-pink-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl bg-white shadow-xl rounded-lg p-8 sm:p-12">
          ...
          >
            ...
            <p
              dangerouslySetInnerHTML={{
                __html: dict.introduction.p1_2.replace(
                  '{privacyPolicyUrl}',
                  privacyPolicyUrl
                ),
              }}
            ...
            <ul>
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.introduction.list.itemA,
                }}
              />
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.introduction.list.itemB,
                }}
              />
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.introduction.list.itemC,
                }}
              />
            </ul>
            ...
            <ul>
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.serviceFees.list.itemA,
                }}
              />
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.serviceFees.list.itemB,
                }}
              />
              <li
                dangerouslySetInnerHTML={{
                  __html: dict.serviceFees.list.itemC,
                }}
              />
            </ul>
            ...
            <h2 id="intellectual-property">
              {dict.intellectualProperty.title}
            </h2>
            <p
              dangerouslySetInnerHTML={{
                __html: dict.intellectualProperty.p4_1,
              }}
            />
            <p
              dangerouslySetInnerHTML={{
                __html: dict.intellectualProperty.p4_2,
              }}
            />
            ...
            <h2 id="limitation-of-liability">
              {dict.limitationOfLiability.title}
            </h2>
            <p
              dangerouslySetInnerHTML={{
                __html: dict.limitationOfLiability.p6_1,
              }}
            />
            <p
              dangerouslySetInnerHTML={{
                __html: dict.limitationOfLiability.p6_2,
              }}
            />
            <p
              dangerouslySetInnerHTML={{
                __html: dict.limitationOfLiability.p6_3,
              }}
            />
            <p
              dangerouslySetInnerHTML={{
                __html: dict.limitationOfLiability.p6_4,
              }}
            />
            ...
            <p
              dangerouslySetInnerHTML={{
                __html: dict.terminationLaw.p8_2.replace(
