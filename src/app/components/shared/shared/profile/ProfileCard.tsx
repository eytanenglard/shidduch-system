...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const SensitiveInfo: React.FC<{ children: React.ReactNode }> = ({
    ...
    return (
      <div className="relative border border-amber-300 rounded-xl p-6 bg-gradient-to-br from-amber-50 to-white shadow-md">
  ...
  const EmptyState: React.FC<{
    ...
    <div className="flex flex-col items-center justify-center py-10 text-gray-400 bg-gray-50/50 rounded-xl border border-gray-100">
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 p-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-6 max-w-3xl mx-auto">
          {/* Profile Image */}
          <div className="relative h-36 w-36 md:h-44 md:w-44 rounded-full overflow-hidden border-4 border-white shadow-lg transition-transform hover:scale-105 duration-300">
            {mainImage ? (
              <Image
                src={mainImage.url}
                alt="תמונת פרופיל"
          ...
          <div className="space-y-3 text-center md:text-right">
            <div>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-2">
                <div className="flex items-center gap-1 text-gray-700 bg-white/80 px-3 py-1 rounded-full shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-start mt-2">
              {profile.isProfileVisible && (
                <Badge className="bg-emerald-100 text-emerald-800 border-0 px-3 py-1.5">
              ...
              {profile.maritalStatus && (
                <Badge
                  variant="outline"
                  className="bg-purple-50 border-purple-200 text-purple-700 px-3 py-1.5"
                >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-6 bg-gray-50">
        ...
        {/* Marital Status */}
        <div className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-pink-50 to-white border border-pink-100 shadow-sm hover:shadow-md transition-all">
        ...
        {/* Education */}
        <div className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100 shadow-sm hover:shadow-md transition-all">
        ...
        {/* Native Language */}
        <div className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-white border border-emerald-100 shadow-sm hover:shadow-md transition-all">
      ...
      <div className="px-6 py-4 border-b border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold flex items-center gap-2">
            ...
            תמונות
            <span className="text-sm bg-gray-100 text-gray-700 rounded-full w-6 h-6 inline-flex items-center justify-center">
              {images.length}
            </span>
          </h3>
          {images.length > 0 && (
        ...
        {images.length > 0 ? (
          <div className="flex gap-2 overflow-x-auto pb-2 snap-x">
            {images.slice(0, 6).map((image, index) => (
              <div
                key={image.id}
                className="relative min-w-[120px] w-28 h-28 rounded-lg overflow-hidden bg-gray-100 shadow-sm cursor-pointer snap-start hover:opacity-90 transition-all duration-300"
            ...
            {images.length > 6 && (
              <div
                className="relative min-w-[120px] w-28 h-28 rounded-lg overflow-hidden bg-gray-100/60 flex items-center justify-center cursor-pointer snap-start hover:bg-gray-100 transition-all duration-300"
                onClick={() => setActiveTab("photos")}
              >
      ...
      <div className="p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="bg-gray-50 p-1 rounded-xl mb-6 sticky top-0 z-10">
            <ScrollArea className="w-full" dir="rtl">
              <TabsList className="w-full justify-start inline-flex bg-transparent">
                <TabsTrigger
                  value="about"
          ...
          <TabsContent
            value="about"
            className="mt-2 space-y-8 focus:outline-none"
          >
            {/* Basic Description */}
            <div className="rounded-2xl p-6 bg-gradient-to-br from-blue-50 to-blue-50/20 border border-blue-100/50 shadow-sm">
              <SectionHeader
                icon={User}
                title="אודות"
            ...
            {/* Hobbies */}
            <div className="rounded-2xl p-6 bg-gradient-to-br from-pink-50 to-pink-50/20 border border-pink-100/50 shadow-sm">
              <SectionHeader
                icon={Heart}
                title="תחביבים"
            ...
            {/* Languages */}
            <div className="rounded-2xl p-6 bg-gradient-to-br from-green-50 to-green-50/20 border border-green-100/50 shadow-sm">
              <SectionHeader
                icon={Languages}
                title="שפות"
          ...
          <TabsContent value="family" className="mt-2 focus:outline-none">
            <div className="rounded-2xl p-6 bg-gradient-to-br from-purple-50 to-purple-50/20 border border-purple-100/50 shadow-sm">
              <SectionHeader
                icon={Users}
                title="מידע משפחתי"
                iconColor="text-purple-600"
          ...
          <TabsContent value="photos" className="mt-2 focus:outline-none">
            <div className="rounded-2xl p-6 bg-gradient-to-br from-gray-50 to-white border border-gray-200/50 shadow-sm">
          ...
          {questionnaire && (
            ...
            >
              <div className="space-y-6">
                ...
                <div className="rounded-xl p-4 bg-white border shadow-sm flex items-center justify-between">
                ...
                {Object.entries(
                  ...
                  return (
                    <div
                      key={world}
                      className={cn(
                        "rounded-2xl p-6 border shadow-sm transition-shadow hover:shadow-md",
                        world === "values" &&
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {profile.referenceName1 && (
                        <div className="p-5 bg-white rounded-xl shadow-sm border border-amber-200">
                          <h4 className="font-medium mb-3 text-amber-700">
                            ממליץ/ה 1
                          </h4>
      ...
      {selectedImageIndex !== null && (
        ...
        >
          <DialogContent className="max-w-4xl p-0 bg-black/95 backdrop-blur-sm border-none shadow-2xl">
            ...
            {/* Thumbnails */}
            <div className="flex gap-2 p-4 overflow-x-auto bg-black/90 justify-center">
              {images.map((image, index) => (
                <div
                  key={image.id}
                  className={cn(
