...
// --- START OF NEW STRUCTURE (inspired by AiMatchAnalysisDialog) ---

// 1. --- Sub-components for better modularity ---
...
// 2. --- DialogBody component: contains all logic and complex JSX ---
...
> = ({
  ...
  }, [suggestedUserId, isDemo]); // Fetch only when these change
...
// 3. --- Main exported wrapper component ---
export const UserAiAnalysisDialog: React.FC<UserAiAnalysisDialogProps> = (
  ...
  // The trigger button logic remains here
  const triggerButton = (
    <Button
      variant="outline"
      size="lg"
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent
        ...
        dir="rtl"
      >
        {/* The DialogBody is only rendered when the dialog is open, which contains the API call logic */}
