...
import { getReferrerByCode, trackClick, createReferralCookieValue, REFERRAL_COOKIE_NAME, REFERRAL_COOKIE_DAYS } from '@/lib/services/referralService';
...
export default async function ReferralRedirect({ params }: ReferralRedirectProps) {
  ...
  try {
    ...
    if (result.success && result.referralId) {
      ...
      const cookieValue = createReferralCookieValue(upperCode, result.referralId);
