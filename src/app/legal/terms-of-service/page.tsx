...
const TermsOfServicePage = () => {
  ...
  const lastUpdatedDate = '5 ביוני 2025';
  ...
  const jurisdictionDistrict = 'מרכז';
        ...
        <div className='container mx-auto max-w-4xl bg-white shadow-xl rounded-lg p-8 sm:p-12'>
          <header className='mb-10 text-center border-b pb-6 border-gray-200'>
            ...
            <p className='mt-3 text-lg text-gray-600'>
              של מערכת השידוכים Matchpoint (מופעלת על ידי {companyNameLegal})
            </p>
          ...
          <article className='prose prose-lg max-w-none text-gray-700 leading-relaxed text-right'>
            ...
            <p>
              ברוכים הבאים למערכת השידוכים Matchpoint (להלן: <strong>{`"המערכת"`}</strong>, <strong>{`"השירות"`}</strong> או <strong>{`"Matchpoint"`}</strong>), המופעלת על ידי {companyNameLegal} (ח.פ. {companyNumber}) (להלן: <strong>{`"החברה"`}</strong>, <strong>{`"אנו"`}</strong>, <strong>{`"שלנו"`}</strong>).
            ...
            <p>
              5.1. <strong>יצירת חשבון:</strong> {`לצורך שימוש ברוב שירותי המערכת, תידרש/י ליצור חשבון אישי. בעת יצירת החשבון ו/או מילוי הפרופיל והשאלונים, הינך מתחייב/ת למסור מידע נכון, מדויק, מלא ועדכני אודותיך, כפי שמתבקש בטפסי ההרשמה והפרופIL.`}
            </p>
            <p>
            ...
            <ul>
                ...
                <li>{`להשתמש בכלים אוטומטיים (כגון בוטים, סקריפטים) לאיסוף מידע מהמערכת או לאינטראקציה עימה, ללא אישור מפורש מהחברה.`}</li>
            </ul>
            <p>
            ...
            <p>
              12.2. <strong>סיום או השעיה על ידי החברה:</strong> {`החברה רשאית, לפי שיקול דעתה הבלעדי, להשעות או לסיים את חשבונך ואת גישתך למערכת, באופן מיידי וללא הודעה מוקדמת, במקרה של הפרת תנאי הסכם זה, התנהגות בלתי הולמת, חשד לפעילות בלתי חוקית או הונאה, או מכל סיבה אחרת שתראה לנכון.`}
            </p>
            <p>
              12.3. <strong>תוצאות סיום:</strong> {`עם סיום ההתקשרות, מכל סיבה שהיא, הרישיון שלך לשימוש במערכת יפקע. החברה תטפל במידע האישי שלך בהתאם למדיניות הפרטיות ולדרישות הדין. סעיפים מסוימים בהסכם זה (כגון קניין רוחני, הגבלת אחריות, שיפוי, דין וסמכות שיפוט) ימשיכו לחול גם לאחר סיום ההתקשרות.`}
            </p>
